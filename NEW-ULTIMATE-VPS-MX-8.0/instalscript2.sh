...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/ThonyDroidYT/SCP/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX_Oficial/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	#chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/ThonyDroidYT/SCP/master/NEW-ULTIMATE-VPS-MX-8.0/Install/zzupdate2.sh -O /usr/local/vpsmxup/vpsmxup.sh &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.sh
	rm -rf /usr/bin/vpsmxup
    wget https://raw.githubusercontent.com/ThonyDroidYT/SCP/master/NEW-ULTIMATE-VPS-MX-8.0/Install/zzupdate2.sh -O /usr/bin/vpsmxup &> /dev/null
...
ubu16_fun () {
    wget -O /etc/apt/sources.list https://raw.githubusercontent.com/ThonyDroidYT/SCP/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX_Oficial/Repositorios/16.04/sources.list &> /dev/null
